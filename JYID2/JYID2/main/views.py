...
def update(request, id):
    jsoncome = json.loads(request.body)
    if request.method == 'POST':
        instance = get_object_or_404(Person, id=id)
        instance.name = jsoncome['firstname']
        instance.last_name = jsoncome['lastname']
        instance.email = jsoncome['email']
        instance.age = jsoncome['age']
        instance.save()
